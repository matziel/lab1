...
print (" Nazywam siê Mateusz Zieliñski. Mój login github to matziel. Jestem na V roku Geodezji i Kartografii na specjalnoœci Geoinformatyka")
print (" Wed³ug mnie podany skrypt porównuje zbiory ocen u¿ytkowników, po czym na podstawie zbie¿noœci ocen zwraca listê u¿ytkowników wed³ug bliskoœci preferencji - Efektem koñcowym jest lista rekomendacji wykonawców dla u¿ytkownika na podstawie preferencji s¹siadów.")
